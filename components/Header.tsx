...
const Header = ({ onCollabClick, onComingNextClick }: HeaderProps) => {
        ...
        <div className="hidden md:flex items-center gap-3">
          <div className="relative">
            <input
              ...
              className="w-64 px-4 py-2 pr-10 bg-gray-100 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#17d4ff]"
            />
